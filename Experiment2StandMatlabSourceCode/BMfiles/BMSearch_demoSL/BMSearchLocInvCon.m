...
% randshiftx=RandSample([-rangex:rangex],[length(markershow),types]);
% randshifty=RandSample([-rangey:rangey],[length(markershow),types]);
for i=1:types
...
BM_Upr=BMtransUpr(BM_Upr);
BM_Inv=BMtransInv(BM_Inv);
